...
#include <itkActiveShapeModelBuilder.h>
#include <itkASMRandomPointIdSampler.h>
#include <itkDeferredItems.h>
...
int main(int argc, char *argv[]) {
    ...
    itk::ASMNormalDirectionFeatureExtractor<MeshType, ImageType>* featureExtractor = new itk::ASMNormalDirectionFeatureExtractor<MeshType, ImageType>(profileSampler);
